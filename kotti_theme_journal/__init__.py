...
library = Library("kotti_theme_journal", "static")
...
def kotti_configure(settings):
    settings['kotti.fanstatic.view_needed'] = 'kotti_theme_journal.view_needed'
    settings['kotti.fanstatic.edit_needed'] = 'kotti_theme_journal.edit_needed'
